...
class TipoEvento:
    ...
    FORMULARIO_APROBACION_REVERTIDA = "FORMULARIO_APROBACION_REVERTIDA"
    FORMULARIO_RECHAZADO = "FORMULARIO_RECHAZADO"
    FORMULARIO_DEVUELTO  = "FORMULARIO_DEVUELTO"
    FORMULARIO_DEVOLUCION_REVERTIDA = "FORMULARIO_DEVOLUCION_REVERTIDA"
    ...
    EXPEDIENTE_REABIERTO_ACTUALIZACION = "EXPEDIENTE_REABIERTO_ACTUALIZACION"
