/**
 * AlertasDireccion — Panel de bloqueo por inconsistencia de dirección.
 *
 * Renderiza una tarjeta de error por cada documento cuya dirección no coincide
 * con el campo "Dirección" del formulario. El panel bloquea el avance: no hay
 * botón de descartar. El usuario debe corregir el campo en el formulario o
 * reemplazar el archivo adjunto.
 *
 * SRP : única responsabilidad — mostrar alertas de inconsistencia de dirección.
  ...
  return (
    <div className="alertas-razon-social" role="alert" aria-live="polite">
      ...
      <div className="alertas-razon-social__encabezado">
        ...
        <strong>
          No puedes avanzar: hay {alertas.length === 1 ? 'una inconsistencia' : `${alertas.length} inconsistencias`} de dirección sin resolver
        </strong>
      </div>

      <p className="alertas-razon-social__instruccion">
        Para cada documento marcado, debes <strong>corregir el campo "Dirección"</strong> en
        el formulario para que coincida con el documento, o bien <strong>reemplazar el archivo adjunto</strong> con
        uno que contenga la dirección correcta. El bloqueo se libera automáticamente al corregir.
      </p>
