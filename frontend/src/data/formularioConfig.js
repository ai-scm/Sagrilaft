...
export const CAMPOS_REQUERIDOS = {
  1: [],
  2: ['tipo_contraparte', 'tipo_persona', 'tipo_solicitud', 'razon_social', 'tipo_identificacion', 'numero_identificacion', 'direccion', 'departamento', 'ciudad', 'telefono', 'fax', 'correo', 'codigo_ica', 'pagina_web'],
