...
export const CATALOGO_CORRECCIONES = [
  ...
  },
  {
    ...
    campos: [
      ...
      { id: 'responsabilidades_renta',      etiqueta: 'Responsabilidades Impuesto sobre la Renta' },
      { id: 'autorretenedor',               etiqueta: 'Autorretenedor' },
      { id: 'responsabilidades_iva',        etiqueta: 'Responsabilidades en el Impuesto sobre las Ventas (IVA)' },
      { id: 'regimen_iva',                  etiqueta: 'Régimen IVA' },
      { id: 'gran_contribuyente',           etiqueta: '¿Es Gran Contribuyente?' },
      { id: 'entidad_sin_animo_lucro',      etiqueta: 'Entidad sin Ánimo de Lucro' },
      { id: 'retencion_ica',                etiqueta: 'Retención de Industria y Comercio' },
      { id: 'impuesto_ica',                 etiqueta: 'Impuesto de Industria y Comercio' },
      { id: 'entidad_oficial',              etiqueta: 'Entidad Oficial' },
      { id: 'exento_retencion_fuente',      etiqueta: 'Exento de Retención en la Fuente' },
