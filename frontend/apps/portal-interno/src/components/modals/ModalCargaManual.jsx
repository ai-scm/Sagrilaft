...
export default function ModalCargaManual({ visible, formularioId, onCargado, onCancelar }) {
  ...
  return (
    <div style={s.fondo} role="dialog" aria-modal="true" aria-labelledby="titulo-modal-carga">
      <div style={s.modal}>
        
        {/* Encabezado */}
        <div style={s.encabezado}>
          <h2 style={s.titulo} id="titulo-modal-carga">
        ...
        <div style={s.cuerpo}>
          ...
          <label style={s.etiqueta} htmlFor="campo-justificacion">
            Justificación del cargue manual
          </label>
          ...
          <div style={s.contadorCaracteres}>
            ...
            {!justificacionValida && justificacion.trim().length > 0 && (
              <span style={s.avisoMinimo}>Mínimo {LONGITUD_MINIMA_JUSTIFICACION} caracteres</span>
            )}
          </div>
