...
export class EcsFargate extends Construct {
  ...
  private backendSecrets(props: EcsFargateProps, idPrefix: string): Record<string, ecs.Secret> {
    return {
      ...
      BEDROCK_MAX_TOKENS: this.ssmSecret('BEDROCK_MAX_TOKENS', props, idPrefix),
      BEDROCK_TEMPERATURE: this.ssmSecret('BEDROCK_TEMPERATURE', props, idPrefix),
      BEDROCK_CONNECT_TIMEOUT_SECONDS: this.ssmSecret('BEDROCK_CONNECT_TIMEOUT_SECONDS', props, idPrefix),
      BEDROCK_READ_TIMEOUT_SECONDS: this.ssmSecret('BEDROCK_READ_TIMEOUT_SECONDS', props, idPrefix),
      BEDROCK_MAX_ATTEMPTS: this.ssmSecret('BEDROCK_MAX_ATTEMPTS', props, idPrefix),
      BEDROCK_PDF_MAX_PAGES: this.ssmSecret('BEDROCK_PDF_MAX_PAGES', props, idPrefix),
      BEDROCK_DEFAULT_CONFIDENCE: this.ssmSecret('BEDROCK_DEFAULT_CONFIDENCE', props, idPrefix),
      BEDROCK_RESPONSE_LOG_CHARS: this.ssmSecret('BEDROCK_RESPONSE_LOG_CHARS', props, idPrefix),
